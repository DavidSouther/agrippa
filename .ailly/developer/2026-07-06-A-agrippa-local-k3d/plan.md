...
- [ ] Feature 1: Cluster core                           Depends on: Feature 0
- [ ] Feature 2: GitOps (ArgoCD)                         Depends on: Feature 1
- [ ] Feature 3: Networking (Istio + cert-manager)       Depends on: Feature 1; applied via Feature 2
